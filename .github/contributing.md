# Contributing to snapdragon-stack

First and foremost, thank you! We appreciate that you want to contribute to snapdragon-stack, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for snapdragon-stack**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for snapdragon-stack:

- star the [project](https://github.com/jonschlinkert/snapdragon-stack)
- tweet your support for snapdragon-stack
...
- **version**: please note the version of snapdragon-stack are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of snapdragon-stack may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/snapdragon-stack
